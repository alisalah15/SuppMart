    ...
    <li><a class="dropdown-item" href="schools.php"> Show All Schools</a></li>
        ...
        <div class="text-end">
            ...
            if(!isset($_SESSION['user'])){?>
                ...
                <a href="checkout.php"> <i class="fa-solid fa-cart-shopping me-lg-3 "></i></a>
                <a type="button" href="handlers/logout.php" class="btn btn-danger">Logout</a>
                <?php
            }
            ?>
            <a href="ar/index.php"> <img src="egypt.JPG" width=40 alt=""></a>
